...
uint8_t MPU6050_init() {
	...
	I2CMasterBuffer[2] 	= 0x01;//0b00000001; // reset device y-axis gyro as clk;
	...
	I2CMasterBuffer[2] 	= 0x00;//0b00000000; // Lowpass
	...
	I2CMasterBuffer[0] 	= MPU6050_ADRESS;
	I2CMasterBuffer[1] 	= MPU6050_RA_PWR_MGMT_1;
	I2CMasterBuffer[2] 	= 0x04;//0b00000100; // wakeup
	...
	I2CMasterBuffer[2] 	= 0x08;//0b00001000; // gyro range 600°/s
	...
	I2CMasterBuffer[2] 	= 0x18;//0b00011000; // 16G range
