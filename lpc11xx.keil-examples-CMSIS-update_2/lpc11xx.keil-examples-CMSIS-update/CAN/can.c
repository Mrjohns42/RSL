/****************************************************************************
 *   $Id:: can.c 9362 2012-04-19 22:37:53Z nxp41306                         $
...
#endif
  while( !(LPC_CAN->STAT & STAT_TXOK) );   		/* Wait for TXOK to be set. */
  LPC_CAN->STAT &= ~STAT_TXOK;					/* Manually clear is required. */
  return;
}
