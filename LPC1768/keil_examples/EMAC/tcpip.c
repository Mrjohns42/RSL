...
void TIMER0_IRQHandler(void)   // Keil: interrupt service routine for timer 0
{
...
// easyWEB internal function
// help function to write a uint16_t in big-endian byte-order
// to MCU-memory
...
// easyWEB internal function
// help function to write a uint32_t in big-endian byte-order
// to MCU-memory
